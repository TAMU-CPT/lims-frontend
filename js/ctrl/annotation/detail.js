/**
 * Annotation detail controller
 * @param {object} base Base angular application object
 */
export default function(base) {
	base.controller("AnnotationDetailCtrl", ["$scope", "$location", "$routeParams", "Restangular",
		function($scope, $location, $routeParams, Restangular) {
			...
			Restangular.one("annotation/annotationrecord", $routeParams.accountID).get().then(function(data) {
				$scope.account = data;
